...
## 2026-05-24 - Replaced native img with Next.js Image
**Learning:** Replaced a native `<img>` tag with Next.js `<Image>` to enable WebP conversion, responsive resizing, and lazy loading, reducing bandwidth consumption.
**Action:** Remember to add an explanatory comment as required by the 'Bolt' prompt when making these optimizations.
