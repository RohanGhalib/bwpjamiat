        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 pr-6">
            ...
            <div className="flex space-x-3">
              <a href="https://www.facebook.com/profile.php?id=61584553894384" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-slate-50 text-[#123962] border border-slate-100 flex items-center justify-center hover:bg-[#1C7F93] hover:text-white hover:border-[#1C7F93] transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
              </a>
              <a href="https://instagram.com/bwp.jamiat" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-slate-50 text-[#123962] border border-slate-100 flex items-center justify-center hover:bg-[#1C7F93] hover:text-white hover:border-[#1C7F93] transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4 text-sm font-semibold text-slate-500">
              ...
              <li><Link href="/ahbab-link" className="hover:text-[#1C7F93] transition-colors flex items-center group"><span className="w-1.5 h-1.5 rounded-full bg-slate-300 group-hover:bg-[#1C7F93] group-hover:scale-150 transition-all mr-3"></span> Apply For Membership</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-100/80 mt-20 pt-8 flex flex-col items-center text-xs text-slate-400 font-bold tracking-wider">
          <div className="w-full flex flex-col md:flex-row justify-between items-center uppercase">
            ...
            <div className="mt-4 md:mt-0 space-x-8">
              <Link href="/" className="hover:text-[#123962] transition-colors">Home</Link>
            </div>
          </div>
