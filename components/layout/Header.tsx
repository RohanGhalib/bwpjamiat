        ...
        <div className="px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <details className="lg:hidden relative">
              <summary className="list-none text-[#123962] p-2 hover:bg-slate-100 rounded-full transition-colors cursor-pointer" aria-label="Toggle menu">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg>
              </summary>
              <nav className="absolute right-0 mt-2 w-[min(84vw,20rem)] border border-slate-200/70 rounded-2xl px-4 py-4 bg-white/95 shadow-xl backdrop-blur-lg">
                <div className="flex flex-col space-y-2 text-sm font-semibold">
                  <Link href="/" className="rounded-xl px-3 py-2 text-[#123962] hover:bg-slate-100 transition-colors">Home</Link>
                  <Link href="/taranas" className="rounded-xl px-3 py-2 text-slate-600 hover:text-[#123962] hover:bg-slate-100 transition-colors">Taranas</Link>
                  <Link href="/literature" className="rounded-xl px-3 py-2 text-slate-600 hover:text-[#123962] hover:bg-slate-100 transition-colors">Literature</Link>
                  <Link href="/articles" className="rounded-xl px-3 py-2 text-slate-600 hover:text-[#123962] hover:bg-slate-100 transition-colors">Articles</Link>
                  <Link href="/events" className="rounded-xl px-3 py-2 text-slate-600 hover:text-[#123962] hover:bg-slate-100 transition-colors">Events</Link>
                  <Link href="/lms" className="rounded-xl px-3 py-2 text-slate-600 hover:text-[#123962] hover:bg-slate-100 transition-colors">LMS</Link>
                  <Link href="/ahbab-link" className="rounded-xl px-3 py-2 text-slate-600 hover:text-[#123962] hover:bg-slate-100 transition-colors sm:hidden">Ahbab Login</Link>
                  <Link href="/contact" className="mt-2 inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-r from-[#1C7F93] to-[#2669A9] text-white rounded-full font-bold text-sm">Join IJT</Link>
                </div>
              </nav>
            </details>
          </div>
