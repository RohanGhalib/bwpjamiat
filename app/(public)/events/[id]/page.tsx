        ...
        <div className="bg-white rounded-[2rem] border border-gray-100 overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col md:flex-row">
          <div className="md:w-1/2 bg-gray-100 relative min-h-[300px] md:min-h-[500px]">
             {eventData.imageUrl ? (
               ...
               // lazy loading, and responsive sizing. Expected to reduce LCP and bandwidth.
               <Image src={eventData.imageUrl} alt={eventData.title || "Event Image"} fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
             ) : (
