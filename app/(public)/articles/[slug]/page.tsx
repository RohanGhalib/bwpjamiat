        ...
        <div className="prose prose-lg max-w-none text-gray-700 prose-img:rounded-2xl prose-headings:text-[#123962] prose-a:text-[#1C7F93] prose-blockquote:border-[#1C7F93]">
           {article.thumbnailUrl && (
             <Image
                ...
                unoptimized={!article.thumbnailUrl.startsWith('/') && !article.thumbnailUrl.includes('firebasestorage.googleapis.com') && !article.thumbnailUrl.includes('r2.dev') && !article.thumbnailUrl.includes('r2.cloudflarestorage.com') && !article.thumbnailUrl.includes('s3.amazonaws.com') && !article.thumbnailUrl.includes('picsum.photos')}
             />
           )}
