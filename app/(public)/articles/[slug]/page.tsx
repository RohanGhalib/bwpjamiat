      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 prose-img:rounded-2xl prose-headings:text-[#123962] prose-a:text-[#1C7F93] prose-blockquote:border-[#1C7F93]">
           {article.thumbnailUrl && (
             <Image src={article.thumbnailUrl} alt={article.title || ""} width={1200} height={630} sizes="(max-width: 896px) 100vw, 896px" className="w-full h-auto rounded-2xl mb-10 object-cover" unoptimized={!isWhitelistedImageDomain(article.thumbnailUrl)} />
           )}
